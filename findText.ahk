  ...
  , ScreenShot:=1, ByRef zx:="", ByRef zy:="", ByRef zw:="", ByRef zh:="")
{
  ...
  , w:=Min(x+w,zx+zw), x:=Max(x,zx), w-=x
  , h:=Min(y+h,zy+zh), y:=Max(y,zy), h-=y
  , w1:=Min(x+w+1,zx+zw), x1:=Max(x-1,zx), w1-=x1, x1-=zx
  , h1:=Min(y+h+1,zy+zh), y1:=Max(y-1,zy), h1-=y1, y1-=zy
  ...
  if (id)
  {
    if (mode:=this.BindWindow(0,0,0,1))<2
    {
      ...
      DllCall("BitBlt","Ptr",mDC,"int",x1,"int",y1,"int",w1,"int",h1
        , "Ptr",hDC2, "int",x1, "int",y1, "uint",0xCC0020|CAPTUREBLT)
    ...
    else
    {
      ...
      DllCall("BitBlt","Ptr",mDC,"int",x1,"int",y1,"int",w1,"int",h1
        , "Ptr",mDC2, "int",x1, "int",y1, "uint",0xCC0020)
  ...
  else
  {
    ...
    DllCall("BitBlt","Ptr",mDC,"int",x1,"int",y1,"int",w1,"int",h1
      , "Ptr",hDC, "int",x1+zx, "int",y1+zy, "uint",0xCC0020|CAPTUREBLT)
...
Gui(cmd, arg1:="")
{
  ...
  Case "MakeMainWindow":
    ...
    %Gui_G%()
    Gui, Add, Edit, x+0 w150 hp vOffset
    Gui, Add, Button, x+0 vCopyOffset Hwndid, % Lang["CopyOffset"]
    %Gui_G%()
    Gui, Font, cBlue
